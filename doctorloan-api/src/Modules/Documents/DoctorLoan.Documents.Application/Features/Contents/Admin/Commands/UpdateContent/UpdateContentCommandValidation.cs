...
namespace DoctorLoan.Contents.Application.Features.Contents.Admin.Commands.UpdateDcoument;
public class UpdateContentCommandValidation : AbstractValidator<UpdateContentCommand>
{
    public UpdateContentCommandValidation(ICurrentTranslateService currentTranslateService)
    {
        #region field names
