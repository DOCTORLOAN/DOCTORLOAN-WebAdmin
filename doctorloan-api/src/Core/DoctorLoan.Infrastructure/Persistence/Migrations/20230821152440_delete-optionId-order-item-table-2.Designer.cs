...
namespace DoctorLoan.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230821152440_delete-optionId-order-item-table-2")]
    partial class deleteoptionIdorderitemtable2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.Orders.OrderItem", b =>
                {
                    ...
                    b.HasOne("DoctorLoan.Domain.Entities.Products.ProductOptionGroup", null)
                        .WithMany("OrderItems")
