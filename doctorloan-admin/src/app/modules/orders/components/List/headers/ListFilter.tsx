...
const ListFilter = ({listOption}: Props) => {
  ...
  const mockStatus = Object.keys(OrderStatusEnum)
    .filter(StringIsNumber)
    .map(
      (key) =>
        ({
          value: key,
          label: OrderStatusEnum[key as unknown as number].replaceAll('_', ' '),
        } as Option)
    )
        ...
        <div className='px-7 py-5' data-kt-order-table-filter='form'>
          ...
          <div className='d-flex justify-content-end'>
            <ButtonFormHook
              ...
              data-kt-order-table-filter='reset'
            >
              Hủy
            </ButtonFormHook>
            ...
            <ButtonFormHook
              ...
              onClick={filterData}
              data-kt-menu-dismiss='true'
              data-kt-order-table-filter='filter'
            >
              Tìm kiếm
            </ButtonFormHook>
          </div>
